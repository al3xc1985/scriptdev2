...
struct MANGOS_DLL_DECL boss_falricAI : public ScriptedAI
{
    ...
    void Reset()
    {
        ...
        m_uiDespairTimer       = m_bIsRegularMode ? 40000 : 30000;
        m_uiHorrorTimer        = urand(25000,35000);
        m_uiStrikeTimer        = urand(10000,15000);
    ...
    void UpdateAI(const uint32 uiDiff)
    {
        ...
        {
            // ToDo - move this in instance script
            ...
            if (m_uiSummonTimer < uiDiff) 
            {
                ...
                {
                    if(m_pInstance)
                        m_pInstance->DoUpdateWorldState(WORLD_STATE_WAVES, 1);
                ...
                if (m_uiSummonCount > 4)
                {
                    ...
                    if(m_pInstance) 
                    {
                        ...
                        m_pInstance->DoUpdateWorldState(WORLD_STATE_WAVES_COUNT, m_uiSummonCount);
                    }
                }
                else 
                {
