...
struct MANGOS_DLL_DECL boss_brundirAI : public ScriptedAI
{
    ...
    {
        if(irand(0,1))
            DoScriptText(SAY_BRUNDIR_SLAY_1, m_creature);
        else
            DoScriptText(SAY_BRUNDIR_SLAY_2, m_creature);
    }
...
struct MANGOS_DLL_DECL boss_molgeimAI : public ScriptedAI
{
    ...
    void JustDied(Unit* pKiller)
    {
        ...
        if(irand(0,1))
            DoScriptText(SAY_MOLGEIM_DEATH_1, m_creature);
        else
            DoScriptText(SAY_MOLGEIM_DEATH_2, m_creature);
    }
    ...
    {
        if(irand(0,1))
            DoScriptText(SAY_MOLGEIM_SLAY_1, m_creature);
        else
            DoScriptText(SAY_MOLGEIM_SLAY_2, m_creature);
    }
...
struct MANGOS_DLL_DECL boss_steelbreakerAI : public ScriptedAI
{
    ...
    void KilledUnit(Unit* pVictim)
    {
        ...
        if(irand(0,1))
            DoScriptText(SAY_STEEL_SLAY_1, m_creature);
        else
            DoScriptText(SAY_STEEL_SLAY_2, m_creature);
    }
    ...
    void JustDied(Unit* pKiller)
    {
        ...
        if(irand(0,1))
            DoScriptText(SAY_STEEL_DEATH_1, m_creature);
        else
            DoScriptText(SAY_STEEL_DEATH_2, m_creature);
    }
