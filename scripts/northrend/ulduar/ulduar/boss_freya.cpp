...
struct MANGOS_DLL_DECL boss_elder_brightleafAI : public ScriptedAI
{
    ...
    {
        if(irand(0,1))
            DoScriptText(SAY_SLAY_1_BRIGHT, m_creature);
        else
            DoScriptText(SAY_SLAY_2_BRIGHT, m_creature);
    }
...
struct MANGOS_DLL_DECL boss_elder_ironbranchAI : public ScriptedAI
{
    ...
    {
        if(irand(0,1))
            DoScriptText(SAY_SLAY_1_IRON, m_creature);
        else
            DoScriptText(SAY_SLAY_2_IRON, m_creature);
    }
...
struct MANGOS_DLL_DECL boss_elder_stonebarkAI : public ScriptedAI
{
    ...
    {
        if(irand(0,1))
            DoScriptText(SAY_SLAY_1_STONE, m_creature);
        else
            DoScriptText(SAY_SLAY_2_STONE, m_creature);
    }
...
struct MANGOS_DLL_DECL mob_freya_groundAI : public ScriptedAI
{
    ...
    void Reset()
    {
        ...
        case NPC_NATURE_BOMB:
            ...
            m_fSize = 1;
            //if(GameObject* pBomb = m_creature->SummonGameobject(GO_NATURE_BOMB, 0, 0, 0, 0, 0))
