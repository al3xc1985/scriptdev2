...
UPDATE gameobject_template SET /*flags = 6553632, */ScriptName="go_broken_harpoon" WHERE entry = 194565;
...
UPDATE creature_template SET ScriptName = "mob_npc_flashFreeze" WHERE entry in (32938, 33353);
...
-- Keepers
-- Keepers images
UPDATE creature_template SET ScriptName = "hodir_image" WHERE entry = 33411;
UPDATE creature_template SET ScriptName = "freya_image" WHERE entry = 33410;
UPDATE creature_template SET ScriptName = "thorim_image" WHERE entry = 33413;
UPDATE creature_template SET ScriptName = "mimiron_image" WHERE entry = 33412;
